        ...
        const { data: pe, error: pErr } = await supabase
          ...
          .select(`
            ...
            equipment_groups(
              ...
              components(id, deleted_at, checklist_items(id, done, flagged, deleted_at, parent_item_id, local_line_id)),
              component_types(
                id, deleted_at,
                checklist_items(id, done, flagged, deleted_at, parent_item_id, local_line_id),
                components(id, deleted_at, checklist_items(id, done, flagged, deleted_at, parent_item_id, local_line_id))
              )
            )
          `)
