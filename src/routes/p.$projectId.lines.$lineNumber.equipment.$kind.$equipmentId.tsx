...
const PHASE_META: Record<Section, { label: string; icon: typeof Wrench; tab: string; tabActive: string; header: string; accent: string }> = {
  assembly: {
    label: "Assembly",
    icon: Wrench,
    tab: "border-white/30 bg-white/10 hover:bg-white/20 text-white/90",
    tabActive: "border-white bg-white text-amber-700 shadow-md",
  ...
  wiring: {
    ...
    icon: Cable,
    tab: "border-white/30 bg-white/10 hover:bg-white/20 text-white/90",
    tabActive: "border-white bg-white text-violet-700 shadow-md",
  ...
  cold_comm: {
    ...
    icon: Snowflake,
    tab: "border-white/30 bg-white/10 hover:bg-white/20 text-white/90",
    tabActive: "border-white bg-white text-cyan-700 shadow-md",
